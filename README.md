...
| **E** | 测试与界面工程 | 自包含断言框架 + 11 个 ctest 回归套件（121 用例，含边界/鲁棒性专项与真实二进制全流程冒烟）、手动测试工作台（数字键 / 表单 / 分屏 / 失败原因提示） |
...
tests/              11 个回归套件（共 121 个用例）+ 自包含断言框架 fh_mini_test.hpp
