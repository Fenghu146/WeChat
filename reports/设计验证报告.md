...
| 测试文件后缀 `_test.cpp` | `group_core_test.cpp`, `e2e_integration_test.cpp` | 全部 10 个测试文件 |
...
app/demo_runner.cpp   ← --demo 自动演示流程
...
| — | 全量测试通过 | 10 套件 / 115 用例 100% 通过 | `ctest --output-on-failure` | ✅ |
